...
* In ESM, called as a regular function: `this` will be `undefined` (you will likely get an error because `this.propName`, cannot read prop off of undefined
    * cjs + sloppy mode - `this` will reference the global object 

* using `call` `apply` or `bind`

* `this` is whatever you set it to be!

    ![image-20220922030539994](./image-20220922030539994.png)



    ![image-20220922030535662](./image-20220922030535662.png)
